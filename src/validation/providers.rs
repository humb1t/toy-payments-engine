...
where Self: HasTransactions + HasAccount
{
...
where Self: HasTransactions + HasDisputedTransactions
{
...
mod tests {
    ...
    use super::*;
    use crate::{account::Account, context::TransactionContext, difference::Difference};
    ...
    fn create_test_validation_context<'a>(
        transactions: &'a mut HashMap<(ClientId, TransactionId), Difference>,
        disputed_transactions: &'a mut HashMap<(ClientId, TransactionId), Difference>,
    ...
    fn test_validate_deposit_success() {
        ...
        let ctx = create_test_validation_context(&mut transactions, &mut disputed_transactions, &mut account);
